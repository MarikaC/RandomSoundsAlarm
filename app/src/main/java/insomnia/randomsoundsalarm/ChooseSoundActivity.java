...
public class ChooseSoundActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SoundListAdapter soundListAdapter = new SoundListAdapter(this);
        final MySQLiteOpenHelper helper = new MySQLiteOpenHelper(getApplicationContext());
        soundListAdapter.setSoundList(helper.setCheckedSoundStatus(Sound.getItems(this)));
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                helper.writeSoundListToDB(soundListAdapter.getSoundList());
                Snackbar.make(view, "Complete save sounds list !!", Snackbar.LENGTH_LONG)
